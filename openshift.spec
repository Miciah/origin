...
%{!?commit:
%global commit 6b301ec676657adda0e56f16423d59c69b2cf64b
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# Openshift specific ldflags from hack/common.sh os::build:ldflags
%{!?ldflags:
%global ldflags -X github.com/openshift/origin/pkg/version.majorFromGit 0 -X github.com/openshift/origin/pkg/version.minorFromGit 3+ -X github.com/openshift/origin/pkg/version.versionFromGit v0.3.2-19-g6b301ec-dirty -X github.com/openshift/origin/pkg/version.commitFromGit 6b301ec -X github.com/GoogleCloudPlatform/kubernetes/pkg/version.gitCommit c977a45 -X github.com/GoogleCloudPlatform/kubernetes/pkg/version.gitVersion v0.10.0-503-gc977a45
}
...
%changelog
* Mon Feb 23 2015 Scott Dodson <sdodson@redhat.com> 0.3.2-1
